...
import removeUser from 'boredom-lib/services/users/remove'
...
const dispatcher = async (event) => {
  ...
  router.http.delete(`/users/:id`, () =>
    removeUser(pathParameters.id).then(() => responseBuilder.success.noContent())
  )
